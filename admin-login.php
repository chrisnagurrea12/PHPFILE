...
<body>
    ...
    <form name="form" action="admin-login.php" onsubmit="return isvalid()" method="POST" class="w3-container w3-display-middle w3-padding-16" style="border: 1px solid black; background-color: 035F95; height:75%; border-radius: 5%;">
