...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->execute()) {
        ...
        echo "<script>alert('Failed to add announcement. Please try again. Error: " . $stmt->error . "'); window.location='admin-announcement.php';</script>";
    }

    $stmt->close();
}

// Fetch announcements (GET request or initial page load)
...
// Close the connection (moved to the end to ensure it's closed after both operations)
$conn->close();

// Now, $announcements array is available for display or further processing in your HTML/PHP.
?>
...
<div class="main">
    ...
    <div class="w3-row">
        <div class="w3-half w3-container">
            <div class="w3-bar" style="background-color:#035F95;">
                <h2 style="color:white; margin-left:5px;"><b>Statistic</b></h2>
            </div>
 		...
 		<div class="w3-half w3-container">
			<div class="w3-bar" style="background-color:#035F95;">
				<h2 style="color:white; margin-left:5px;"><b>Announcements</b></h2>
			</div>
		<div style="margin-right:5px; width:100%; height:400px; overflow-y:auto; background-color: white; border-style: solid;">
		<div style="align-items: center; margin-left:30px;">
				<h1 style="font-size:20px; color:Black"><b>Create an Announcement</b></h1>
				<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
					...
					<button type="submit" class="button w3-green" style=" margin-top: 5px; font-size:20px;">Submit</button>
				</form>
		</div>
                    ...
                    <ul>
                        <?php foreach ($users as $user): ?>
                            <li>
                                ...
                                Full Name: <?php echo htmlspecialchars($user['firstname']); ?>
                            </li>
                        <?php endforeach; ?>
                    </ul>
                <?php else: ?>
        ...
        var pieChart1 = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [25, 30, 20, 15, 10],
                    backgroundColor: ['#FF5733', '#33FF57', '#3357FF', '#F1C40F', '#ee82ee'],
